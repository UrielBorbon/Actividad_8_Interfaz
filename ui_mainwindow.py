...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.spinBox_5, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_6, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_7, 9, 2, 1, 1)
